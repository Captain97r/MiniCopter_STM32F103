...
#define ACC_SETTINGS_MEMSEC  (uint32_t)0x0800FF40
#define MAG_SETTINGS_MEMSEC  (uint32_t)0x0800FF70
...
HAL_StatusTypeDef MPU9250_read_reg_multi(uint8_t address, uint8_t *data, uint8_t size)
{
	uint8_t addr[1] = { address };
	HAL_StatusTypeDef status = MPU9250_write(addr, 1);
	...
	return HAL_I2C_Master_Receive(mpu9250.hi2c, (uint16_t)MPU9250_ADDRESS, (uint8_t *)data, size, 1000);
}
...
HAL_StatusTypeDef AK8963_read_reg_multi(uint8_t address, uint8_t *data, uint8_t size)
{
	uint8_t addr[1] = { address };
	HAL_StatusTypeDef status = AK8963_write(addr, 1);
	...
	return HAL_I2C_Master_Receive(mpu9250.hi2c, (uint16_t)AK8963_ADDRESS, (uint8_t *)data, size, 100);
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////																											///////////////////////////////////////
///////////////////////////////////////////								     MPU9250 AUXILARY PRIVATE FUNCTIONS										///////////////////////////////////////
///////////////////////////////////////////																											///////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////																											///////////////////////////////////////
///////////////////////////////////////////								         MPU9250 PRIVATE INIT FUNCTIONS										///////////////////////////////////////
///////////////////////////////////////////																											///////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
HAL_StatusTypeDef AK8963_startup(MPU9250_init_t *mpu9250_init)
{
	...
	AK8963_write_reg(AK8963_CNTL, mpu9250_init->mag_freq);
	HAL_Delay(50);
...
HAL_StatusTypeDef MPU9250_init(MPU9250_init_t *mpu9250_init)
{
	...
	{
	case AFS_2G:
		mpu9250.accelerometer.resolution	= 20.0 / 32768.0;
		break;
	case AFS_4G:
		mpu9250.accelerometer.resolution	= 40.0 / 32768.0;
		break;
	case AFS_8G:
		mpu9250.accelerometer.resolution	= 80.0 / 32768.0;
		break;
	case AFS_16G:
		mpu9250.accelerometer.resolution	= 160.0 / 32768.0;
		break;
	}
	...
	mpu9250.isPresent = MPU9250_who_am_i();
...
{
	uint8_t responce;
	AK8963_read_reg(AK8963_WHO_AM_I, &responce);
	return (responce == 0x48) ? HAL_OK : HAL_ERROR;
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////																											///////////////////////////////////////
///////////////////////////////////////////										 MPU9250 DATA ACQUIRE FUNCTIONS										///////////////////////////////////////
///////////////////////////////////////////																											///////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void MPU9250_get_temp()
{
	...
	MPU9250_read_reg_multi(TEMP_OUT_H, rawData, 2);
	mpu9250.temperature = 21.0 + (((int16_t)(((int16_t)rawData[0]) << 8 | rawData[1])) - 4096) / 333.87;	// Turn the MSB and LSB into a 16-bit value
}

void MPU9250_get_accel()
{
	uint8_t rawData[6];
	MPU9250_read_reg_multi(ACCEL_XOUT_H, rawData, 6);
	
	mpu9250.accelerometer.data.x = ((int16_t)(((int16_t)rawData[0] << 8) | rawData[1])) * mpu9250.accelerometer.resolution - mpu9250.accelerometer.offset.x;
	mpu9250.accelerometer.data.y = ((int16_t)(((int16_t)rawData[2] << 8) | rawData[3])) * mpu9250.accelerometer.resolution - mpu9250.accelerometer.offset.y; 
	mpu9250.accelerometer.data.z = ((int16_t)(((int16_t)rawData[4] << 8) | rawData[5])) * mpu9250.accelerometer.resolution - mpu9250.accelerometer.offset.z;
	
	
	if (mpu9250.accelerometer.dcm[0][0] != 0 && mpu9250.accelerometer.dcm[1][1] != 0 && mpu9250.accelerometer.dcm[1][1] != 0)
	{
		Dcmf acc;
		acc[0][0] = mpu9250.accelerometer.data.x;
		acc[1][0] = mpu9250.accelerometer.data.y;
		acc[2][0] = mpu9250.accelerometer.data.z;
		
		Dcmf result = { { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } };
		matrix_multiply(&mpu9250.accelerometer.dcm, &acc, 3, 1, &result);
		
		mpu9250.accelerometer.data.x = result[0][0];
		mpu9250.accelerometer.data.y = result[1][0];
		mpu9250.accelerometer.data.z = result[2][0];
	}
}
...
{
	uint8_t rawData[6];
	MPU9250_read_reg_multi(GYRO_XOUT_H, rawData, 6);
	
	mpu9250.gyroscope.data.x = (((int16_t)(((int16_t)rawData[0] << 8) | rawData[1])) * mpu9250.gyroscope.resolution * M_PI / 180) - mpu9250.gyroscope.offset.x;
	mpu9250.gyroscope.data.y = (((int16_t)(((int16_t)rawData[2] << 8) | rawData[3])) * mpu9250.gyroscope.resolution * M_PI / 180) - mpu9250.gyroscope.offset.y;
	mpu9250.gyroscope.data.z = (((int16_t)(((int16_t)rawData[4] << 8) | rawData[5])) * mpu9250.gyroscope.resolution * M_PI / 180) - mpu9250.gyroscope.offset.z;
...
void MPU9250_get_mag()
{
	...
	if (ready & AK8963_DRDY) 
	{
		...
		AK8963_read_reg_multi(AK8963_XOUT_L, rawData, 7);
		...
		if (!(rawData[6] & AK8963_HOFL)) 
		{
			...
			//Without calibration matrix
				...
				mpu9250.magnetometer.data.x = ((int16_t)(((int16_t)rawData[1] << 8) | rawData[0])) * mpu9250.magnetometer.resolution - mpu9250.magnetometer.offset.x;
				mpu9250.magnetometer.data.y = ((int16_t)(((int16_t)rawData[3] << 8) | rawData[2])) * mpu9250.magnetometer.resolution - mpu9250.magnetometer.offset.y;
				mpu9250.magnetometer.data.z = ((int16_t)(((int16_t)rawData[5] << 8) | rawData[4])) * mpu9250.magnetometer.resolution - mpu9250.magnetometer.offset.z;
			if (mpu9250.magnetometer.dcm[0][0] != 0 && mpu9250.magnetometer.dcm[1][1] != 0 && mpu9250.magnetometer.dcm[1][1] != 0)
			{
				Dcmf mag;
				mag[0][0] = mpu9250.magnetometer.data.x;
				mag[1][0] = mpu9250.magnetometer.data.y;
				mag[2][0] = mpu9250.magnetometer.data.z;
		
				Dcmf result = { { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } };
				matrix_multiply(&mpu9250.magnetometer.dcm, &mag, 3, 1, &result);
		
				mpu9250.magnetometer.data.x = result[0][0];
				mpu9250.magnetometer.data.y = result[1][0];
				mpu9250.magnetometer.data.z = result[2][0];
			}
		}
	}
}
...
HAL_StatusTypeDef MPU9250_self_test()
{
	...
	for(int ii = 0 ; ii < 200 ; ii++) {
		...
		MPU9250_read_reg_multi(ACCEL_XOUT_H, rawData, 6);      // Read the six raw data registers into data array
		
		aAvg[0] += (int16_t)(((int16_t)rawData[0] << 8) | rawData[1]);   // Turn the MSB and LSB into a signed 16-bit value
		aAvg[1] += (int16_t)(((int16_t)rawData[2] << 8) | rawData[3]);
		aAvg[2] += (int16_t)(((int16_t)rawData[4] << 8) | rawData[5]);
  
		MPU9250_read_reg_multi(GYRO_XOUT_H, rawData, 6);     // Read the six raw data registers sequentially into data array
...
void save_calibration_to_flash()
{
	...
	uint32_t data_to_flash[24] = {	*(uint32_t *)(&mpu9250.accelerometer.dcm[0][0]), *(uint32_t *)(&mpu9250.accelerometer.dcm[0][1]), *(uint32_t *)(&mpu9250.accelerometer.dcm[0][2]),
									*(uint32_t *)(&mpu9250.accelerometer.dcm[1][0]), *(uint32_t *)(&mpu9250.accelerometer.dcm[1][1]), *(uint32_t *)(&mpu9250.accelerometer.dcm[1][2]),
									*(uint32_t *)(&mpu9250.accelerometer.dcm[2][0]), *(uint32_t *)(&mpu9250.accelerometer.dcm[2][1]), *(uint32_t *)(&mpu9250.accelerometer.dcm[2][2]),
									*(uint32_t *)(&mpu9250.accelerometer.offset.x),  *(uint32_t *)(&mpu9250.accelerometer.offset.y),  *(uint32_t *)(&mpu9250.accelerometer.offset.z),
									*(uint32_t *)(&mpu9250.magnetometer.dcm[0][0]),  *(uint32_t *)(&mpu9250.magnetometer.dcm[0][1]),  *(uint32_t *)(&mpu9250.magnetometer.dcm[0][2]),
									*(uint32_t *)(&mpu9250.magnetometer.dcm[1][0]),  *(uint32_t *)(&mpu9250.magnetometer.dcm[1][1]),  *(uint32_t *)(&mpu9250.magnetometer.dcm[1][2]),
									*(uint32_t *)(&mpu9250.magnetometer.dcm[2][0]),  *(uint32_t *)(&mpu9250.magnetometer.dcm[2][1]),  *(uint32_t *)(&mpu9250.magnetometer.dcm[2][2]),
									*(uint32_t *)(&mpu9250.magnetometer.offset.x),   *(uint32_t *)(&mpu9250.magnetometer.offset.y),   *(uint32_t *)(&mpu9250.magnetometer.offset.z)		};
	
	HAL_FLASH_Unlock();
	FLASH_page_erase(ACC_SETTINGS_MEMSEC);
	FLASH_write((uint8_t *)data_to_flash, ACC_SETTINGS_MEMSEC, sizeof(data_to_flash));
	HAL_FLASH_Lock();
}

void load_calibration_from_flash()
{
	uint32_t data_from_flash[24] = { 0 };
	
	FLASH_read((uint32_t *)data_from_flash, ACC_SETTINGS_MEMSEC, sizeof(data_from_flash));
